...
if (isset($_POST['action']) && $_POST['action'] == 'insert') {
    ...
    $id=(int) $_POST['id'];
    $q = "UPDATE kursai SET kursuPavadinimas='$courseName' WHERE id=$id";
...
$id=(int) $_GET['id'];
$g="SELECT * FROM `kursai` WHERE id=$id";
$result=$db->query($g);
...
<h2>Kursai <button type="button" class="btn btn-primary" data-toggle="modal"
				...
				<div class="modal-dialog" role="document">
					<div class="modal-content">
						<div class="modal-header">
							<h5 class="modal-title" id="exampleModalLabel">Vartotojo sukūrimas</h5>
			...
			<form action="kursai_redaguoti.php" method="post">
							<input type="hidden" name="action" value="insert">
							<input type="hidden" name="id" value="<?php echo $id?>">
							<div class="form-group">
								<label for="vardas">Vardas</label> <input name="kursuPavadinimas"
									type="text"  class="form-control" id="vardas"
									value="<?php echo $course['kursuPavadinimas'] ?>">
							</div>
							<input type="submit" class="btn btn-primary" value="Išsaugoti">
						</form>
